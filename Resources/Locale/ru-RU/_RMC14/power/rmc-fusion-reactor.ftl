rmc-fusion-reactor-insert-already-has-cell = В {$reactor} уже установлена батарейка. Сначала извлеките её ломом!
...
rmc-fusion-reactor-remove-none = Нет батарейки для извлечения из {$reactor}.
...
rmc-fusion-reactor-repair-different-tool = Вам нужен другой инструмент для ремонта {$reactor}.
